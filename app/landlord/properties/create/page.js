        ...
        <Layout>
            <div className="min-h-screen bg-gray-50 pt-20 pb-12">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold text-zinc-900 mb-8">List a New Property</h1>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {/* Title */}
                            <div>
                                <label className="block text-sm font-bold text-zinc-700 mb-2">Property Title</label>
                                <input
                                    type="text"
                                    name="title"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-zinc-700 mb-2">Monthly Rent (₹)</label>
                                    <input
                                        type="number"
                                        name="price"
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-zinc-700 mb-2">Nearest College/University</label>
                                    <input
                                        type="text"
                                        name="college"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-zinc-700 mb-2">Gender Preference</label>
                                    <select
                                        name="gender"
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-zinc-700 mb-2">Amenities (Comma separated)</label>
                                    <input
                                        type="text"
                                        name="amenities"
                            ...
                            {/* Map Location */}
                            <div>
                                <label className="block text-sm font-bold text-zinc-700 mb-2">Location (Click on map to pin)</label>
                                <div className="h-[500px] rounded-2xl overflow-hidden border-2 border-gray-200 shadow-inner group-hover:border-blue-400 transition-colors">
                                    <Map onLocationSelect={handleLocationSelect} selectedLocation={formData.location} />
                                </div>
                                {formData.location ? (
                                    <div className="flex items-center gap-2 mt-3 text-sm text-blue-600 bg-blue-50 p-3 rounded-xl border border-blue-100 animate-in fade-in">
                                        ...
                                        <span className="font-medium">Location pinned successfully!</span>
                                    </div>
                                ) : (
                                    <p className="text-sm text-gray-500 mt-2 flex items-center gap-2">
                                        ...
                                        Use the <strong>"Locate Me"</strong> button or click on the map.
                                    </p>
                                )}
                            </div>
                            {/* Submit Button */}
